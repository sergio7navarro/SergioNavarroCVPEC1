...
class Parcel {
  ...
  async _init() {
    ...
    _classPrivateFieldSet(this, _config, new (_ParcelConfig().default)(config, resolvedOptions.packageManager, resolvedOptions.inputFS, resolvedOptions.shouldAutoInstall));
