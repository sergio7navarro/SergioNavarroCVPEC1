...
const generator = { ..._astring().baseGenerator,
  ...
  Program(node, state) {
    ...
    _astring().baseGenerator.Program.call(this, node, state);
  },

  BlockStatement(node, state) {
    handleDirectives(node);

    _astring().baseGenerator.BlockStatement.call(this, node, state);
  },
  ...
  RegExpLiteral(node, state) {
    ...
    _astring().baseGenerator.Literal(node, state);
  },
  ...
  ArrowFunctionExpression(node, state) {
    ...
    _astring().baseGenerator.ArrowFunctionExpression.call(this, node, state);
  },
  ...
  OptionalMemberExpression(node, state) {
    ...
    _astring().baseGenerator.MemberExpression.call(this, node, state);
  },
  ...
  OptionalCallExpression(node, state) {
    ...
    _astring().baseGenerator.CallExpression.call(this, node, state);
  },
  ...
  ExportNamedDeclaration(node, state) {
    ...
    _astring().baseGenerator[node.type].call(this, node, state);
  },
  ...
  ReturnStatement(node, state) {
    ...
    if (((_node$argument = node.argument) === null || _node$argument === void 0 ? void 0 : (_node$argument$leadin = _node$argument.leadingComments) === null || _node$argument$leadin === void 0 ? void 0 : _node$argument$leadin.length) > 0) {
      ...
      _astring().baseGenerator.ReturnStatement.call(this, node, state);
    }
  }
